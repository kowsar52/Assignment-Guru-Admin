...
<div class="xp-breadcrumbbar">
   <div class="row">      
       <div class="col-md-6 col-lg-6"> 
           <h4 class="xp-page-title">Add Coupon</h4>
       </div>
       <div class="col-md-6 col-lg-6">
		...
		<div class="col-lg-12">
            <div class="card m-b-30">
            	<div class="card-header bg-white">
                    <h5 class="card-title text-black">Add Coupon</h5>
                </div>
                <div class="card-body">
                    <form class="xp-form-validate" action="{{url('admin/coupon/add')}}" method="post" id="create_form">
                    	@csrf
                    	@if ($errors->any())
