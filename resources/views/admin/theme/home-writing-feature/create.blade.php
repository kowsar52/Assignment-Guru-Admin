...
<div class="xp-breadcrumbbar">
   <div class="row">      
       <div class="col-md-6 col-lg-6"> 
           <h4 class="xp-page-title">Add Writing Service Features</h4>
       </div>
       <div class="col-md-6 col-lg-6">
           <div class="xp-breadcrumb">
               <ol class="breadcrumb">
                   <li class="breadcrumb-item"><a href="{{route('admin/dashboard')}}"><i class="icon-home"></i></a></li>
                   <li class="breadcrumb-item active" aria-current="page">Add Writing Service Features</li>
               </ol>
           </div>
       </div>
   </div>          
		...
		<div class="col-lg-12">
            <div class="card m-b-30">
            	<div class="card-header bg-white">
                    <h5 class="card-title text-black">Add Writing Service Features</h5>
                </div>
                <div class="card-body">
                    <form class="xp-form-validate" action="{{url('admin/home/add-writing-service-features')}}" method="post" id="create_form" enctype="multipart/form-data">
                    	@csrf
                    	@if ($errors->any())
                      ...
                      @endif
	                    ...
	                    <div class="form-group row">
	                       ...
	                       <div class="col-lg-8">
	                           <textarea class="form-control"  id="description_content" name="description_content" placeholder="Enter description"></textarea>
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                if (data.error == true) {
                    ...
                    window.location.href = '{{url('admin/home/writing-service-features')}}';
                }
