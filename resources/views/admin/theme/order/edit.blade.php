                    ...
                    <form class="xp-form-validate" action="{{url('admin/theme/edit-order-page-content',$content->id)}}" method="post" id="create_form" enctype="multipart/form-data">
                      ...
                      @endif
	                    ...
	                    <div class="form-group row">
	                       ...
	                       <div class="col-lg-8">
	                           <textarea class="form-control"  id="short_description_content" name="short_description_content" placeholder="Enter short description">{{$content->short_description}}</textarea>
	                    ...
	                    <div class="form-group row">
	                       ...
	                       <div class="col-lg-8">
	                           ...
	                           <img src="{{url('/')}}/{{$content->icon}}" style="width: 40px;">
	                       </div>
	                    </div>
                        <div class="form-group row">
