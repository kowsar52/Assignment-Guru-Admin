...
<div class="xp-breadcrumbbar">
   <div class="row">      
       <div class="col-md-6 col-lg-6"> 
           <h4 class="xp-page-title">Add Page</h4>
       </div>
       <div class="col-md-6 col-lg-6">
		...
		<div class="col-lg-12">
            <div class="card m-b-30">
            	<div class="card-header bg-white">
                    <h5 class="card-title text-black">Add Page</h5>
                </div>
                <div class="card-body">
                    <form class="xp-form-validate" action="{{url('admin/pages/add-page')}}" method="post" id="create_form">
                    	@csrf
                    	@if ($errors->any())
                      ...
                      @endphp
	                       ...
	                       <div class="col-lg-8">
	                           <select class="form-control" id="page_name" name="page_name">
	                               ...
	                               @foreach($pages_name as $page_name)
	                                    <option value="{{$page_name['slug']}}">{{$page_name['name']}}</option>
	                               @endforeach
	                           </select>
	                    ...
	                    <div class="form-group row">
	                       ...
	                       <div class="col-lg-8">
	                           <textarea class="form-control" id="heading" name="heading" placeholder="Enter Short Description" rows="3"></textarea>
