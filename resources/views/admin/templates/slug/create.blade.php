...
<div class="xp-breadcrumbbar">
   <div class="row">      
       <div class="col-md-6 col-lg-6"> 
           <h4 class="xp-page-title">Add Template Page Slug</h4>
       </div>
       <div class="col-md-6 col-lg-6">
           <div class="xp-breadcrumb">
               <ol class="breadcrumb">
                   <li class="breadcrumb-item"><a href="{{route('admin/dashboard')}}"><i class="icon-home"></i></a></li>
                   <li class="breadcrumb-item active" aria-current="page">Add Slug</li>
               </ol>
           </div>
       </div>
   </div>          
		...
		<div class="col-lg-12">
            <div class="card m-b-30">
            	<div class="card-header bg-white">
                    <h5 class="card-title text-black">Add Template Page Slug</h5>
                </div>
                <div class="card-body">
                    <form class="xp-form-validate" action="{{url('admin/add-template-slug')}}" method="post" id="create_form">
                    	@csrf
                    	@if ($errors->any())
                      ...
                      @endif
	                    ...
	                    <div class="form-group row">
	                       ...
	                       <div class="col-lg-8">
	                           <textarea class="form-control" id="name"  name="name" placeholder="Enter name" rows="3"></textarea>
