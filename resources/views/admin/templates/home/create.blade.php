	...
	<div class="row">
		<div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form class="xp-form-validate" action="{{url('admin/add-template-translation')}}" method="post" id="create_form">
                    	@csrf
                    	@if ($errors->any())
                      ...
                      @endif
                       ...
                       <div class="form-group row">
	                    ...
	                    <div class="form-group row">
	                       ...
	                       <div class="col-lg-8">
	                           <textarea class="form-control"  id="translation" name="translation" rows="3" placeholder="Enter translation"></textarea>
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                if (data.error == true) {
                    ...
                    window.location.href = '{{url('admin/template-translation')}}';
                }
                $('#submit_btn').prop('disabled', false);
            }
        });
