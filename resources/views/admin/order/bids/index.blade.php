...
<div class="xp-breadcrumbbar">
   <div class="row">      
       <div class="col-md-6 col-lg-6"> 
           <h4 class="xp-page-title">Bids</h4>
       </div>
   </div>          
</div>
...
function Edit(id)
{
          ...
          $.ajax({
              type:"get",
              url: '{{url('admin/orders/bids/edit')}}',
              dataType:'json',
              data:{id:id},
        ...
        function Delete(id)
        {
            Swal.fire({
              ...
              if (result.isConfirmed) {
                    $.ajax({
                      type:"get",
                      url: "{{url('admin/orders/bids/delete')}}"+'/'+id,
                      success:function(data){
                          if(data.error == true)
                          {
                              Swal.fire(
  ...
  $(document).ready(function() {
      ...
      var table = $('#dataTable').DataTable( {
          ...
          responsive: true,
            ...
            ajax: "{{ url('admin/orders/bids') }}",
  
            columns: [
  
              {data: 'DT_RowIndex', name: 'DT_RowIndex',orderable: false, searchable: false},
                {data: 'writer', name: 'writer',searchable: false},
                {data: 'bidding_price', name: 'bidding_price',searchable: false},
