...
<div class="xp-breadcrumbbar">
   <div class="row">      
       <div class="col-md-6 col-lg-6"> 
           <h4 class="xp-page-title">Invitations</h4>
       </div>
   </div>          
</div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalTItle">Edit Invitation</h5>
...
function Edit(id)
{
          ...
          $.ajax({
              type:"get",
              url: '{{url('admin/orders/invitations/edit')}}',
              dataType:'json',
              data:{id:id},
        ...
        function Delete(id)
        {
            Swal.fire({
              ...
              if (result.isConfirmed) {
                    $.ajax({
                      type:"get",
                      url: "{{url('admin/orders/invitations/delete')}}"+'/'+id,
                      success:function(data){
                          if(data.error == true)
                          {
                              Swal.fire(
  ...
  $(document).ready(function() {
      ...
      var table = $('#dataTable').DataTable( {
          ...
          responsive: true,
            ...
            ajax: "{{ url('admin/orders/invitations') }}",
